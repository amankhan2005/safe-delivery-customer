...
//     // Orders
//     getMyOrders()
//       .then((r) => setOrders(r.data.data.orders?.slice(0, 3) || []))
//       .catch(() => {});
...
//       // Support both { data: [...] } and direct array shapes
...
//     paddingTop: Platform.OS === 'ios' ? 52 : SIZES.xl,
...
//   heroImg:     { width: 130, alignItems: 'center', paddingBottom: SIZES.sm },
