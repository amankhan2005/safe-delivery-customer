...
// KEY FIX: no-cache prevents Android okhttp 304 returning stale/empty order data
const NO_CACHE = {
  headers: {
...
export const verifyPhoneOTP = (data) => withRetry(() => api.post('/auth/verify-phone-otp', data));
...
export const createOrder    = (data) => withRetry(() => api.post('/orders/create', data));
